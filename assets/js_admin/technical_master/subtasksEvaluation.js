...
const tabla = $('#tableSubstaksEvaluations').DataTable({
	// searching: true,
	language: {
...
create_edit_substask = () =>{
    ...
    if(edit){
        url = "api/update/substakEvaluation";
        ...
        url = "api/create/substakEvaluation";
...
des_hab_sub = (id, state) => {
    ...
    $.ajax({
        type: "POST",
        url: host_url + "api/des_hab/substakEvaluation",
        data: {data},
        crossOrigin: false,
        dataType: "json",
        success: (result) => {
