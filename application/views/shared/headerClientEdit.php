             ...
             <li class="nav-item">
                ...
                <div id="collapseOrders" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo base_url(); ?>adminOrdersByClient"><i class="far fa-list-alt"></i>  Lista General</a>
                        <a class="collapse-item" href="<?php echo base_url(); ?>adminOrdersApproveByClient"><i class="far fa-list-alt"></i>  Espera de Aprobación</a>
                    </div>
                </div>
                <hr class="sidebar-divider">
            </li>
