<div id="content-wrapper">
    <div class="container-fluid mb-5">
        <ol class="breadcrumb">
            <li class="breadcrumb-item active">Subtareas de reparaciones, OT: <?= $id ?></li>
        ...
        <div class="card mb-3">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                    <div class="card-body">
                        En esta sección se podrá realizar la elaboración de las subtareas de reparación de las OT que han sido ingresadas por sistema , ademas de su respectiva aprobación por parte de técnico master.
                    </div>
                </div>
            </div>
        </div>
...
<script src="<?php echo base_url(); ?>assets/js_admin/technical_master/substaksReparation.js"></script>
<script>
  $( function() {
