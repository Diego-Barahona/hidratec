<div id="content-wrapper">
  <div class="container-fluid mb-5">
    ...
    <ol class="breadcrumb">
      <li class="breadcrumb-item active" id="header-title">Reportes KPI producción</li>
    </ol>
      ...
      <div class="card-body">
             ...
             <br>
              <div class="row justify-content-left " >
                  ...
                  <div class="col-md-3 mb-3" >
                   <label for="actividad">Promedio kpi producción anual</label>
...
<script src="<?php echo base_url(); ?>assets/js_admin/kpiProduction.js"></script>